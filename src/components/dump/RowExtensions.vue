<template>
  <div class="flex flex-row space-x-2.5 justify-start items-center">
    ...
    <button v-if="false" class="--backtrace --button --transparent" @click="emit('copyImage')">
    ...
    <button class="--backtrace --button --transparent" @click="emit('toggleBacktrace')">
      <fa-icon icon="code" class="mr-1"></fa-icon>
      <span class="text-gray-500 dark:text-gray-300">backtrace</span>
    </button>

    <button class="--backtrace --button --transparent" @click="emit('copyJson')">
      <fa-icon icon="copy" class="mr-1"></fa-icon>
      <span class="text-gray-500 dark:text-gray-300">Copy Json</span>
    </button>

    <button class="--backtrace --button --transparent" @click="emit('copyAssocArray')">
      <fa-icon icon="copy" class="mr-1"></fa-icon>
