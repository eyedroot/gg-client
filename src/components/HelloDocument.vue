<template>
  <div class="flex flex-col justify-center w-full items-center h-fit my-20 dark:text-gray-200 px-10">
    ...
    <div class="flex flex-col space-y-10 mt-12">
      ...
      <section>
        ...
        <div class="p-5 text-base bg-gray-200 rounded dark:bg-gray-800">GG_HOST=host.docker.internal</div>
      </section>
    </div>
  </div>
</template>
